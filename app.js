...
function diagnosticChecks(){
 ...
 const checks=[
  ...
  ['Spójność wersji',document.title.includes('5.1.0')&&document.querySelector('h1')?.textContent.includes('5.1.0')&&document.querySelector('.footer')?.textContent.includes('5.1.0'),'tytuł, nagłówek i stopka']
 ];
 return checks;
}
