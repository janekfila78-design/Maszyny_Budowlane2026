...
function diagnosticChecks(){
 ...
 const checks=[
  ...
  ['Spójność wersji',document.title.includes('5.0.1')&&document.querySelector('h1')?.textContent.includes('5.0.1')&&document.querySelector('.footer')?.textContent.includes('5.0.1'),'tytuł, nagłówek i stopka']
 ];
 return checks;
}
